...
import Restuarant from "./Restuarant.jsx";
import Pizza from "./Pizza.jsx";
import PizzaTruck from './Truck.jsx'
import CarCanvas from './PizzaFace.jsx'
  ...
  return (
    <Helmet title="Home">
      ...
      <section className="why__choose-us">
        <Container>
          <Row>
            <Col lg="6" md="6" className="marginpizza">
